...
@click.option('--output-file', default='studies_report.tsv', help='Output TSV file path')
...
def export_studies(
    ...
    """
    Export specified fields from the 'studies' MongoDB collection to a TSV file.
